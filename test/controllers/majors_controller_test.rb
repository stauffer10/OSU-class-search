...
class MajorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create major" do
    assert_difference('Major.count') do
      post majors_url, params: { major: { description: @major.description, majorname: @major.majorname } }
    end
  ...
  test "should update major" do
    patch major_url(@major), params: { major: { description: @major.description, majorname: @major.majorname } }
